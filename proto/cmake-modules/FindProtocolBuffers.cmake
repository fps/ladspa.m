...
IF (PROTOBUF_FOUND)
  ...
  FUNCTION(WRAP_PROTO VAR)
    ...
    FOREACH(FIL ${ARGN})
	  ...
	  GET_FILENAME_COMPONENT(FILE_REL ${FIL} PATH)
      LIST(APPEND ${VAR} "${CMAKE_CURRENT_BINARY_DIR}/${FILE_REL}/${FIL_WE}.pb.cc")
      LIST(APPEND INCL "${CMAKE_CURRENT_BINARY_DIR}/${FILE_REL}/${FIL_WE}.pb.h")
